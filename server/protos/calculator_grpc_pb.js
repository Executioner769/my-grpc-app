...
function serialize_calculator_ComputeAverageRequest(arg) {
    if (!(arg instanceof protos_calculator_pb.ComputeAverageRequest)) {
        throw new Error(
            "Expected argument of type calculator.ComputeAverageRequest"
        );
    }
...
function deserialize_calculator_ComputeAverageRequest(buffer_arg) {
    return protos_calculator_pb.ComputeAverageRequest.deserializeBinary(
...
function serialize_calculator_ComputeAverageResponse(arg) {
    if (!(arg instanceof protos_calculator_pb.ComputeAverageResponse)) {
        throw new Error(
            "Expected argument of type calculator.ComputeAverageResponse"
        );
    }
    return Buffer.from(arg.serializeBinary());
}
...
function deserialize_calculator_ComputeAverageResponse(buffer_arg) {
    return protos_calculator_pb.ComputeAverageResponse.deserializeBinary(
        new Uint8Array(buffer_arg)
    );
}
...
function serialize_calculator_FindMaximumRequest(arg) {
    if (!(arg instanceof protos_calculator_pb.FindMaximumRequest)) {
        throw new Error(
            "Expected argument of type calculator.FindMaximumRequest"
        );
    }
    return Buffer.from(arg.serializeBinary());
}
...
function deserialize_calculator_FindMaximumRequest(buffer_arg) {
    return protos_calculator_pb.FindMaximumRequest.deserializeBinary(
        new Uint8Array(buffer_arg)
    );
}
...
function serialize_calculator_FindMaximumResponse(arg) {
    if (!(arg instanceof protos_calculator_pb.FindMaximumResponse)) {
        throw new Error(
            "Expected argument of type calculator.FindMaximumResponse"
        );
    }
    return Buffer.from(arg.serializeBinary());
}
...
function deserialize_calculator_FindMaximumResponse(buffer_arg) {
    return protos_calculator_pb.FindMaximumResponse.deserializeBinary(
        new Uint8Array(buffer_arg)
    );
}
...
function serialize_calculator_PrimeNumberDecompositionRequest(arg) {
    if (
        !(arg instanceof protos_calculator_pb.PrimeNumberDecompositionRequest)
    ) {
        throw new Error(
            "Expected argument of type calculator.PrimeNumberDecompositionRequest"
        );
    }
    return Buffer.from(arg.serializeBinary());
}
...
function deserialize_calculator_PrimeNumberDecompositionRequest(buffer_arg) {
    return protos_calculator_pb.PrimeNumberDecompositionRequest.deserializeBinary(
        new Uint8Array(buffer_arg)
    );
}
...
function serialize_calculator_PrimeNumberDecompositionResponse(arg) {
    if (
        !(arg instanceof protos_calculator_pb.PrimeNumberDecompositionResponse)
    ) {
        throw new Error(
            "Expected argument of type calculator.PrimeNumberDecompositionResponse"
        );
    }
    return Buffer.from(arg.serializeBinary());
}
...
function deserialize_calculator_PrimeNumberDecompositionResponse(buffer_arg) {
    return protos_calculator_pb.PrimeNumberDecompositionResponse.deserializeBinary(
        new Uint8Array(buffer_arg)
    );
}
...
function deserialize_calculator_SumRequest(buffer_arg) {
    return protos_calculator_pb.SumRequest.deserializeBinary(
        new Uint8Array(buffer_arg)
    );
}
...
function deserialize_calculator_SumResponse(buffer_arg) {
    return protos_calculator_pb.SumResponse.deserializeBinary(
        new Uint8Array(buffer_arg)
    );
}
...
var CalculatorServiceService = (exports.CalculatorServiceService = {
    ...
    primeNumberDecomposition: {
        ...
        requestDeserialize:
            deserialize_calculator_PrimeNumberDecompositionRequest,
        responseSerialize:
            serialize_calculator_PrimeNumberDecompositionResponse,
        responseDeserialize:
            deserialize_calculator_PrimeNumberDecompositionResponse,
    },
...
exports.CalculatorServiceClient = grpc.makeGenericClientConstructor(
